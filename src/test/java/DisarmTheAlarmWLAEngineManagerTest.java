...
public class DisarmTheAlarmWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DisarmTheAlarmWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DisarmTheAlarmIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DisarmTheAlarmIW/InitOutcome.xml").getDocumentElement();
